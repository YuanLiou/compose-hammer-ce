...
class QuickCodeLexer {
    ...
    private fun LexerScope.parse(rules: List<() -> Boolean>) {
        for (rule in rules) {
            if (rule()) {
    ...
    private fun LexerScope.variable(): Boolean =
        parseToken(
    ...
    private fun LexerScope.ifOpenBracket() =
        parseToken(
            condition = isInsideIfCondition,
    ...
    private fun LexerScope.ifCloseBracket() =
        parseToken(
            condition = isInsideIfCondition,
    ...
    private fun LexerScope.ifAndCond() =
        parseToken(
            condition = isInsideIfCondition,
    ...
    private fun LexerScope.ifOrCond() =
        parseToken(
            condition = isInsideIfCondition,
    ...
    private fun LexerScope.ifBoolVar() =
        parseToken(
            condition = isInsideIfCondition,
    ...
    private fun LexerScope.thenCond() =
        parseToken(
            condition = isInsideIfCondition,
    ...
    private fun LexerScope.elseIfCond() =
        parseToken(
            condition = !isInsideIfCondition,
    ...
    private fun LexerScope.elseCond() =
        parseToken(
            condition = !isInsideIfCondition,
    ...
    private fun LexerScope.endIfCond() =
        parseToken(
            condition = !isInsideIfCondition,
    ...
    private fun String.indexOfOrNull(
        string: String,
        startIndex: Int
    ): Int? = indexOf(string, startIndex).takeIf { it != -1 }
